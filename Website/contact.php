      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 style="margin-top:15px;margin-bottom:10px;">Contact</h1>
          </div>
          <div style="margin-bottom:15px;" class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          If you have any questions, have spotted some errors or want to know more about the research, you can contact the website owner Rick de Boer at Rick.deBoer@hotmail.com
          </div>
        </div>
      </div>
    </header>
